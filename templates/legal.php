        ...
        <div class="legal-content" style="font-size: 0.95rem;">
            <?php if ($lang === 'tr'): ?>
                <?php if ($isPrivacy): ?>
                    ...
                    <p>domainawait hizmetlerini kullanırken, hesabınızı yönetmek ve hizmet kalitesini sürdürmek amacıyla aşağıdaki bilgileri topluyoruz:</p>
                    <ul>
                ...
                <?php else: ?>
                    ...
                    <p>domainawait, kullanıcılarına alan adı (domain) ve hosting sürelerini izleme, WHOIS sorgulama ve REST API aracılığıyla geliştirici araçları sağlama amaçlı bir SaaS platformudur.</p>

                    <h3 style="color: #ffffff; margin-top: 1.5rem;">2. Kullanım Koşulları ve Sorumluluk</h3>
                    <p>Sistemimiz, süre dolumlarını e-posta ve webhook bildirimleri aracılığıyla takip etmenizi kolaylaştırır. Ancak, e-posta servislerindeki gecikmeler, spam filtreleri veya üçüncü taraf sunuculardaki aksaklıklar sebebiyle kaçırılan alan adı yenilemelerinden domainawait hiçbir şekilde sorumlu tutulamaz. Kritik alan adlarınızı manuel olarak da kontrol etmeniz önerilir.</p>
            ...
            <?php elseif ($lang === 'es'): ?>
                <?php if ($isPrivacy): ?>
                    ...
                    <p>Al utilizar los servicios de domainawait, recopilamos la siguiente información para gestionar su cuenta y mantener la calidad del servicio:</p>
                    <ul>
                ...
                <?php else: ?>
                    ...
                    <p>domainawait es una plataforma SaaS diseñada para permitir a los usuarios rastrear el vencimiento de dominios y hosting, realizar consultas WHOIS y utilizar herramientas de desarrollo a través de una API REST.</p>

                    <h3 style="color: #ffffff; margin-top: 1.5rem;">2. Condiciones de Uso y Responsabilidad</h3>
                    <p>Nuestro sistema le ayuda a realizar el seguimiento a través de correo electrónico y notificaciones de webhook. Sin embargo, domainawait no se hace responsable de las renovaciones de dominio fallidas debido a retrasos en el correo, filtros de spam o problemas con servidores de terceros. Se recomienda verificar manualmente sus dominios críticos.</p>
            ...
            <?php elseif ($lang === 'de'): ?>
                <?php if ($isPrivacy): ?>
                    ...
                    <p>Bei der Nutzung von domainawait-Diensten erheben wir folgende Daten, um Ihr Konto zu verwalten und die Dienstqualität sicherzustellen:</p>
                    <ul>
                ...
                <?php else: ?>
                    ...
                    <p>domainawait ist eine SaaS-Plattform zur Überwachung von Domains und Webhosting-Verlängerungen sowie zur Bereitstellung von WHOIS- und API-Tools für Entwickler.</p>

                    <h3 style="color: #ffffff; margin-top: 1.5rem;">2. Nutzungsbedingungen und Haftung</h3>
                    <p>Obwohl wir automatisierte Benachrichtigungen senden, haftet domainawait nicht für versäumte Domainverlängerungen infolge von E-Mail-Verzögerungen, Spam-Filtern oder Serverausfällen. Wir empfehlen, kritische Domains zusätzlich manuell zu kontrollieren.</p>
            ...
            <?php else: ?>
                ...
                <?php if ($isPrivacy): ?>
                    ...
                    <p>When you use domainawait services, we collect the following information to manage your account and maintain service quality:</p>
                    <ul>
                ...
                <?php else: ?>
                    ...
                    <p>domainawait is a SaaS utility designed to allow webmasters to track domain names, monitor hosting expiration schedules, perform WHOIS lookups, and execute REST API queries.</p>

                    <h3 style="color: #ffffff; margin-top: 1.5rem;">2. Term Policies & Liability</h3>
                    <p>While our alerts help you track renewals, domainawait is not responsible for failed domain registrations or missed renewals caused by SMTP delays, network down times, or spam filters. Critical domains should be checked manually.</p>
