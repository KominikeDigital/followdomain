    ...
    <footer class="app-footer">
        <div class="container footer-container">
            ...
            <div class="footer-links">
                ...
                <?php
                $socialUrls = [
                    'twitter' => trim((string)($config['social_twitter_url'] ?? '')),
                    'github' => trim((string)($config['social_github_url'] ?? '')),
                    'linkedin' => trim((string)($config['social_linkedin_url'] ?? '')),
                    'instagram' => trim((string)($config['social_instagram_url'] ?? '')),
                ];
                ...
                <?php if ($hasSocialLinks): ?>
                    <div class="link-group">
                        ...
                        <div class="social-icons-grid" style="display: flex; gap: 0.75rem; margin-top: 0.75rem; flex-wrap: wrap;">
                            <?php if ($socialUrls['twitter'] !== '' && $socialUrls['twitter'] !== '#'): ?>
                                <a href="<?php echo esc($socialUrls['twitter']); ?>" class="social-icon-link" aria-label="X / Twitter" target="_blank" rel="noopener nofollow me" style="color: var(--color-text-secondary); transition: color 0.2s; display: inline-flex; align-items: center; justify-content: center; width: 36px; height: 36px; border-radius: 50%; background: rgba(255, 255, 255, 0.03); border: 1px solid var(--color-border);">
                            ...
                            <?php endif; ?>
                            <?php if ($socialUrls['github'] !== '' && $socialUrls['github'] !== '#'): ?>
                                <a href="<?php echo esc($socialUrls['github']); ?>" class="social-icon-link" aria-label="GitHub" target="_blank" rel="noopener nofollow me" style="color: var(--color-text-secondary); transition: color 0.2s; display: inline-flex; align-items: center; justify-content: center; width: 36px; height: 36px; border-radius: 50%; background: rgba(255, 255, 255, 0.03); border: 1px solid var(--color-border);">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"/></svg>
                                </a>
                            <?php endif; ?>
                            <?php if ($socialUrls['linkedin'] !== '' && $socialUrls['linkedin'] !== '#'): ?>
                                <a href="<?php echo esc($socialUrls['linkedin']); ?>" class="social-icon-link" aria-label="LinkedIn" target="_blank" rel="noopener nofollow me" style="color: var(--color-text-secondary); transition: color 0.2s; display: inline-flex; align-items: center; justify-content: center; width: 36px; height: 36px; border-radius: 50%; background: rgba(255, 255, 255, 0.03); border: 1px solid var(--color-border);">
                            ...
                            <?php endif; ?>
                            <?php if ($socialUrls['instagram'] !== '' && $socialUrls['instagram'] !== '#'): ?>
                                <a href="<?php echo esc($socialUrls['instagram']); ?>" class="social-icon-link" aria-label="Instagram" target="_blank" rel="noopener nofollow me" style="color: var(--color-text-secondary); transition: color 0.2s; display: inline-flex; align-items: center; justify-content: center; width: 36px; height: 36px; border-radius: 50%; background: rgba(255, 255, 255, 0.03); border: 1px solid var(--color-border);">
